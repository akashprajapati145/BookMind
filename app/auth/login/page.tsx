  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="glass w-full max-w-sm rounded-2xl p-8">
        ...
        <h1 className="font-display text-3xl font-bold text-on-background">Welcome back</h1>
        <p className="mt-2 text-sm text-on-surface-variant">Sign in to your library</p>
