...
const MESSAGES = [
  ...
  "Selecting the key examples...",
  "Writing your learning sections...",
  "Almost ready..."
];

type AutoModeGeneratorProps = {
  slug: string;
  mode: string;
};

export function AutoModeGenerator({ slug, mode }: AutoModeGeneratorProps) {
  ...
  useEffect(() => {
    ...
    fetch(`/api/books/${slug}/modes/${mode}`, { method: "POST" })
      .then(async (res) => {
  ...
  return (
    <div className="glass rounded-2xl p-10 text-center">
      ...
      <p className="text-sm font-bold uppercase tracking-[0.18em] text-secondary">Generating</p>
